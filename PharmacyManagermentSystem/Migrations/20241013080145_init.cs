        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Assistantherb = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DestructiveMedicines", x => new { x.CategoryId, x.BatchNumber, x.MedicineId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DestructiveMedicines_Medicines_MedicineId_BatchNumber_Categ~",
                        columns: x => new { x.MedicineId, x.BatchNumber, x.CategoryId },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReturnSuppliers", x => new { x.CategoryId, x.MedicineId, x.BatchNumber });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReturnSuppliers_Medicines_MedicineId_BatchNumber_CategoryId",
                        columns: x => new { x.MedicineId, x.BatchNumber, x.CategoryId },
                        principalTable: "Medicines",
                        principalColumns: new[] { "Id", "BatchNumber", "CategoryId" },
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReceiptDetails", x => new { x.ReceiptId, x.BatchNumber, x.MedicineId });
                    table.ForeignKey(
                        name: "FK_ReceiptDetails_Categorys_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categorys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderDetails_Medicines_MedicineId_BatchNumber_CategoryId",
                        columns: x => new { x.MedicineId, x.BatchNumber, x.CategoryId },
                        principalTable: "Medicines",
                        principalColumns: new[] { "Id", "BatchNumber", "CategoryId" },
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DestructiveMedicines_MedicineId_BatchNumber_CategoryId",
                table: "DestructiveMedicines",
                columns: new[] { "MedicineId", "BatchNumber", "CategoryId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetails_MedicineId_BatchNumber_CategoryId",
                table: "OrderDetails",
                columns: new[] { "MedicineId", "BatchNumber", "CategoryId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReceiptDetails_CategoryId_BatchNumber_MedicineId",
                table: "ReceiptDetails",
                columns: new[] { "CategoryId", "BatchNumber", "MedicineId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReturnSuppliers_MedicineId_BatchNumber_CategoryId",
                table: "ReturnSuppliers",
                columns: new[] { "MedicineId", "BatchNumber", "CategoryId" });
